...
public enum ErrorCode {
    ...
    OTP_MISMATCH("Mã OTP không đúng. Vui lòng thử lại."),
    OTP_MAX_RESEND("Đã vượt quá số lần gửi lại OTP."),
    OTP_RESEND_COOLDOWN("Vui lòng chờ trước khi yêu cầu gửi lại OTP."),
    OTP_CHALLENGE_INVALID("Mã xác thực không còn hiệu lực. Vui lòng bắt đầu lại."),
    PASSWORD_POLICY_VIOLATION("Mật khẩu mới không hợp lệ."),
