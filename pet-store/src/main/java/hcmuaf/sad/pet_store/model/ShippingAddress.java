...
public class ShippingAddress extends BaseEntity {
    ...
    public void insert() {
        try {
            ...
            DBUtils.jdbc().update("""
                    ...
                    addressDetail, latitude, longitude, isDefault,
        ...
        try {
            ...
            DBUtils.tx().executeWithoutResult(status -> {
                ...
                DBUtils.jdbc().update("""
                        ...
                        WHERE address_id = ? AND is_current = true
                        """, now, addressId);
                DBUtils.jdbc().update("""
                        INSERT INTO shipping_addresses
                        (address_id, user_code, recipient_name, phone, place_id, full_address,
                        ...
                        """,
                        addressId, userCode, recipientName, phone, placeId, fullAddress,
                        addressDetail, latitude, longitude, isDefault, now, now);
            });
    ...
    public static void updateDefaultAddress(String userCode, String addressId) {
        try {
            ...
            DBUtils.tx().executeWithoutResult(status -> {
                DBUtils.jdbc().update("""
                        ...
                        WHERE user_code = ? AND is_default = true AND is_current = true
                        """, userCode);
                DBUtils.jdbc().update("""
                        UPDATE shipping_addresses
                        SET is_default = true
    ...
    public boolean belongsTo(String expectedUserCode) {
        return userCode != null && userCode.equals(expectedUserCode);
    }
